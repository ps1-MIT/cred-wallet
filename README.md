...
I also ended up removing some entries from the generated .solidarity file to get past build errors. I think this file shouldn't be checked in, so here are my contents for reference:
```
{
